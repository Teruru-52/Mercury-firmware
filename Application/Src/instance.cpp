...
const uint32_t ir_start_base = 2500;
const uint32_t ir_wall_base = 2150;
const uint32_t ir_fl_base = 2220;
const uint32_t ir_fr_base = 2280;
const uint32_t ir_sl_base = 3670;
const uint32_t ir_sr_base = 3540;
const std::vector<uint32_t> ir_parameters = {ir_wall_base, ir_fl_base, ir_fr_base, ir_sl_base, ir_sr_base};
...
PID pid_ir_sensor_front_left(0.00005, 0.00005, 0.0, 0.0, control_period);
PID pid_ir_sensor_front_right(0.00005, 0.00005, 0.0, 0.0, control_period);
